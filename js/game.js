const Game=function(){
    ...
    this.succes =document.getElementById("succes");
    ...
    this.draw=function(cc){
        ...
        drawImg(cc,this.player,this.ship.x,this.ship.y,this.ship.w,this.ship.h);
    }
    ...
    this.updateMissiles=function(cc){
        for(let i=0;i<this.shipMissiles.length;i++){
            ...
            drawRect(cc,missile.x,missile.y,this.missileWidth,this.missileHeight,shipMissileColor);
        }
        ...
        for(let i=0;i<this.invadersMissiles.length;i++){
            ...
            drawRect(cc,missile.x,missile.y,this.missileWidth,this.missileHeight,invaderMissileColor);
        }
    }
